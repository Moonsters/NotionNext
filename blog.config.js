...
const BLOG = {
  ...
  WIDGET_PET_LINK:
        ...
        'https://github.com/Moonsters/live2d-widget/blob/master/waifu-tips.json', // https://github.com/Moonsters/live2d-widget/blob/master/waifu-tips.json掛件模型地址 @see https://github.com/xiazeyu/live2d-widget-models    https://fastly.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/waifu-tips.json   https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json
