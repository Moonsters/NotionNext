...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'next', // 主題， 支持 ['next','hexo',"fukasawa','medium','example','matery','gitbook','simple'] @see https://preview.tangly1024.com
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true,//false, // 是否顯示切換主題按鈕
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mail@gmail.com', // 郵箱地址 例如mail@tangly1024.com
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Moonsters', // 你的github個人主頁 例如 https://github.com/tangly1024
  ...
  PRISM_THEME_PREFIX_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.css', // 代碼塊默認主題
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否開啟淺色/深色模式代碼主題切換； 開啟後將顯示以下兩個主題
  PRISM_THEME_LIGHT_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-solarizedlight.css', // 淺色模式主題
  PRISM_THEME_DARK_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-okaidia.min.css', // 深色模式主題
  ...
  CODE_COLLAPSE: process.env.NEXT_PUBLIC_CODE_COLLAPSE || true, // 是否摺疊代碼框
  // END********代碼相關********
  ...
  // 所有支持的分享服務：link(複製鏈接),wechat(微信),qq,weibo(微博),email(郵件),facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena
  ...
  // 櫻花飄落特效
  SAKURA: process.env.NEXT_PUBLIC_SAKURA || false, //true,// 開關
  // 漂浮線段特效
  NEST: process.env.NEXT_PUBLIC_NEST || false, //true,// 開關
  // 動態彩帶特效
  ...
  //   ********掛件組件相關********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || null, // 是否顯示chatbase機器人 https://www.chatbase.co/
  // 懸浮掛件
  WIDGET_PET: process.env.NEXT_PUBLIC_WIDGET_PET || true, // 是否顯示寵物掛件
  WIDGET_PET_LINK:
        process.env.NEXT_PUBLIC_WIDGET_PET_LINK ||
        'https://cdn.jsdelivr.net/npm/live2d-widget-model-shizuku/assets/shizuku.model.json', // https://github.com/Moonsters/live2d-widget/blob/master/waifu-tips.json掛件模型地址 @see https://github.com/xiazeyu/live2d-widget-models    https://fastly.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/waifu-tips.json   https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.staticfile.org/twikoo/1.6.16/twikoo.all.min.js', // twikoo客戶端cdn
  ...
  //cusdis see https://cusdis.com/
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'd93ce0c9-3c27-4d07-9264-185d0a8c9f7a', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
