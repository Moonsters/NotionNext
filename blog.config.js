...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true,//false, // 是否显示切换主题按钮
  ...
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true,//false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
  ...
  // 樱花飘落特效
  SAKURA: process.env.NEXT_PUBLIC_SAKURA || true,//false, // 开关
  // 漂浮线段特效
  NEST: process.env.NEXT_PUBLIC_NEST || true,//false, // 开关
  // 动态彩带特效
  FLUTTERINGRIBBON: process.env.NEXT_PUBLIC_FLUTTERINGRIBBON || true,//false, // 开关
  // 静态彩带特效
  RIBBON: process.env.NEXT_PUBLIC_RIBBON || true,//false, // 开关
  // 星空雨特效 黑夜模式才会生效
  STARRY_SKY: process.env.NEXT_PUBLIC_STARRY_SKY || true,//false, // 开关
